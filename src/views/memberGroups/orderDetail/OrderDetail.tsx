                              ...
                              <div className={cx("order-item")}>
                                ...
                                <div className={cx("order-item__info")}>
                                  ...
                                  <div className={cx("info__sub-title")}>
                                    <div className={cx("sub-title__item")}>
                                      Đen
                                    </div>
              ...
              <div className={cx("payment-info")}>
                ...
                <div className={cx("payment-info__content")}>
                  ...
                  <div className={cx("content__item")}>
                    ...
                    {(order.coupon > 0 && (
                      <p>{formatter.format(order.coupon)}đ</p>
                    )) || <p>{order.coupon}đ</p>}
                  </div>
                  <div className={cx("content__item")}>
                    ...
                    <p>
                      {(order.shipping > 0 && (
                        <p>{formatter.format(order.shipping)}đ</p>
                      )) || <p>Miễn phí</p>}
                    </p>
                  </div>
