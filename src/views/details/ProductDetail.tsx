...
import SlideProductDetail from "../../components/slideProductDetail/SlideProductDetail";
          ...
          <div className={cx("block-detail-product", "wrap")}>
            <Grid container spacing={2}>
              ...
              >
                    ...
                    >
                      {product.images.map((image, index) => (
                        <div
                          className={cx(
                            "swiper-slide",
                            imageIndex === index && "swiper-slide-thumb-active"
                          )}
                          key={index}
                ...
                <div className={cx("same-product-title-option")}>
                  <div
                    className={cx("same-product-title-option__item", "active")}
                  >
                    Sản phẩm tương tự
                  </div>
                  <div className={cx("same-product-title-option__item")}>
                    Sản phẩm khác
                  </div>
                </div>
                <div>
                  <SlideProductDetail products={products} product={product} />
                </div>
              </Grid>
              <Grid
                item
